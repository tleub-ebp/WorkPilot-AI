# WorkPilot AI CLI Usage

This document covers terminal-only usage of WorkPilot AI. **For most users, we recommend using the [Desktop UI](#) instead** - it provides a better experience with visual task management, progress tracking, and automatic Python environment setup.

## When to Use CLI

- You prefer terminal workflows
- You're running on a headless server
- You're integrating WorkPilot AI into scripts or CI/CD
...
WorkPilot AI uses Git worktrees for isolated builds:
