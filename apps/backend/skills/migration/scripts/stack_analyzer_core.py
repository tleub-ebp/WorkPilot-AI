...
class StackAnalyzerCore:
    ...
    def analyze_from_data(self, languages=None, frameworks=None, dependencies=None) -> StackAnalysis:
    ...
    def _check_indicator(self, root: Path, indicator: str, framework: str) -> bool:
        ...
        if ":" in indicator:
            ...
            if config_path.exists() and config_path.stat().st_size < 1024 * 1024:  # < 1MB
                try:
