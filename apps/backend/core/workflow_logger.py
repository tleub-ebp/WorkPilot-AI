...
class WorkflowLogger:
    ...
    def log_agent_start(
        self, agent_name: str, action: str, metadata: dict[str, Any] | None = None
    ):
    ...
    def log_agent_end(
        ...
        workflow_status = (
            WorkflowStatus.END if status == "success" else WorkflowStatus.ERROR
        )
    ...
    def log_skill_start(
        self, skill_name: str, action: str, metadata: dict[str, Any] | None = None
    ):
    ...
    def log_hook_start(
        self, hook_name: str, action: str, metadata: dict[str, Any] | None = None
    ):
    ...
    def log_orchestrator_start(
        self, component_name: str, action: str, metadata: dict[str, Any] | None = None
    ):
