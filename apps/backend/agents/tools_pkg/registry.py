...
Central registry for creating and managing workpilot MCP tools.
"""
...
def create_auto_claude_mcp_server(spec_dir: Path, project_dir: Path):
    """
    Create an MCP server with workpilot custom tools.
    ...
    return create_sdk_mcp_server(name="workpilot", version="1.0.0", tools=tools)
