...
def add_quality_commands(subparsers):
    ...
    quality_parser = subparsers.add_parser(
        "quality", help="Commandes de scoring de qualité de code"
    )
    ...
    score_parser = quality_subparsers.add_parser(
        "score", help="Analyser la qualité du code"
    )
    ...
    score_parser.add_argument("--output", help="Fichier de sortie pour JSON")
