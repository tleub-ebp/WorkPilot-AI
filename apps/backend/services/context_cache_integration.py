...
from .intelligent_context_cache import get_context_cache, CacheConfig
...
class ContextCacheIntegrator:
    ...
    def __init__(self, project_path: Path, config: Optional[CacheConfig] = None):
        ...
        self.git_invalidator = GitBasedCacheInvalidator(project_path, self.context_cache)
    ...
    def get_context_with_cache(self, request: ContextRequest, 
                             context_generator: callable) -> ContextResponse:
...
class AgentWorkflowIntegrator:
    ...
    def _setup_default_generators(self):
        ...
        self.context_generators['planning'] = analysis_context_generator  # Use analysis for planning
        self.context_generators['review'] = analysis_context_generator  # Use analysis for review
    
    def get_agent_context(self, agent_type: str, request_data: Dict[str, Any]) -> ContextResponse:
        ...
        if not generator:
            ...
            logger.warning(f"No specific generator for {agent_type}, using analysis generator")
    ...
    def invalidate_workflow_cache(self, agent_type: Optional[str] = None):
