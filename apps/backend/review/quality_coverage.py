...
class TestCoverageAnalyzer:
    ...
    def generate_issues(self, coverage_stats: dict[str, Any]) -> list[QualityIssue]:
        ...
        for entity in untested[:20]:
            severity = IssueSeverity.HIGH if entity['type'] == 'class' else IssueSeverity.MEDIUM
...
def analyze_project_coverage(project_dir: Path) -> tuple[dict[str, Any], list[QualityIssue]]:
    """
