...
class MigrationCache:
    ...
    def get(self, content: str, source: str, target: str) -> Optional[TransformationResult]:
    ...
    def set(self, content: str, source: str, target: str, result: TransformationResult) -> None:
...
class IncrementalMigration:
    ...
    def __init__(self, project_dir: str):
        ...
        self.state_file = self.project_dir / ".auto-claude" / "migration" / "incremental_state.json"
    ...
    def get_progress(self) -> Dict[str, Any]:
        ...
        total = len(self.state["migrated_files"]) + len(self.state["pending_files"]) + len(self.state["failed_files"])
        ...
        return {
            ...
            "total": total,
            "progress_percent": round(len(self.state["migrated_files"]) / total * 100, 2) if total > 0 else 0,
        }
