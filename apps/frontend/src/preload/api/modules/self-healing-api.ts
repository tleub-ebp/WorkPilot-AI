...
export const createSelfHealingAPI = (): SelfHealingAPIObject => ({
  getDashboard: (projectPath) =>
    ipcRenderer.invoke(CH.DASHBOARD, projectPath),
  ...
  getFragility: (projectPath) =>
    ipcRenderer.invoke(CH.FRAGILITY, projectPath),

  cicdEnable: (projectPath) =>
    ipcRenderer.invoke(CH.CICD_ENABLE, projectPath),
