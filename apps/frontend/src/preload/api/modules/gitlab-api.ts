...
export interface GitLabAPI {
	...
	getGitLabAutoFixConfig: (
		projectId: string,
	) => Promise<GitLabAutoFixConfig | null>;
	saveGitLabAutoFixConfig: (
		projectId: string,
		config: GitLabAutoFixConfig,
	) => Promise<boolean>;
	getGitLabAutoFixQueue: (
		projectId: string,
	) => Promise<GitLabAutoFixQueueItem[]>;
	checkGitLabAutoFixLabels: (projectId: string) => Promise<number[]>;
	checkNewGitLabAutoFixIssues: (
		projectId: string,
	...
	getGitLabTriageConfig: (
		projectId: string,
	) => Promise<GitLabTriageConfig | null>;
	saveGitLabTriageConfig: (
		projectId: string,
		config: GitLabTriageConfig,
	) => Promise<boolean>;
	getGitLabTriageResults: (projectId: string) => Promise<GitLabTriageResult[]>;
	runGitLabTriage: (projectId: string, issueIids?: number[]) => void;
	applyGitLabTriageLabels: (
		projectId: string,
		issueIid: number,
		labelsToAdd: string[],
	...
	startGitLabAuth: (
		...
		IPCResult<{ deviceCode: string; verificationUrl: string; userCode: string }>
	>;
	getGitLabToken: (
		instanceUrl?: string,
