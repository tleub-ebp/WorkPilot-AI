...
*This automated review found no issues. Generated by WorkPilot AI.*`;
      ...
      expect(cleanReviewMessage).toContain('## ✅ WorkPilot AI PR Review - PASSED');
      expect(cleanReviewMessage).toContain('**Status:** All code is good');
      expect(cleanReviewMessage).toContain(reviewResult.summary);
      expect(cleanReviewMessage).toContain('*This automated review found no issues. Generated by WorkPilot AI.*');
    });
