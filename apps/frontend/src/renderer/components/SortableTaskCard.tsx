...
export const SortableTaskCard = memo(function SortableTaskCard({ task, onClick, onStatusChange, onDelete, onViewPRFiles, onPreviewApp, isSelectable, isSelected, onToggleSelect }: SortableTaskCardProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
