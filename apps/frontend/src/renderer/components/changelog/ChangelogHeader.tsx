    ...
    <div className="flex items-center justify-between border-b border-border px-6 py-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 mr-4">
          <StepIndicator step={1} currentStep={step} label={t('stepLabels.select')} />
          <div className="w-6 h-px bg-border" />
          <StepIndicator step={2} currentStep={step} label={t('stepLabels.generate')} />
          <div className="w-6 h-px bg-border" />
          <StepIndicator step={3} currentStep={step} label={t('stepLabels.release')} />
        </div>
