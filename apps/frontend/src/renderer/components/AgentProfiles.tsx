import { Brain, Check, Scale, Zap } from "lucide-react";
import {
	AVAILABLE_MODELS,
				...
				<div className="max-w-2xl mx-auto space-y-4">
					...
					<div className="rounded-lg bg-muted/50 p-4 mb-6">
						<p className="text-sm text-muted-foreground">
							Agent profiles provide preset configurations for Claude model and
							thinking level. When you create a new task, these settings will be
							used as defaults. You can always override them in the task
							creation wizard.
						</p>
					</div>
