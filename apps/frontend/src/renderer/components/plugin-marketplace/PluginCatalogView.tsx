...
const TYPE_FILTERS: Array<{ value: PluginType | 'all'; labelKey: string }> = [
  ...
  { value: 'integration', labelKey: 'common:pluginMarketplace.types.integration' },
  { value: 'spec-template', labelKey: 'common:pluginMarketplace.types.specTemplate' },
  { value: 'theme', labelKey: 'common:pluginMarketplace.types.theme' },
  { value: 'custom-prompt', labelKey: 'common:pluginMarketplace.types.customPrompt' },
];
      ...
      <div className="shrink-0 border-b border-border px-6 py-3 space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <option value="popular">{t('common:pluginMarketplace.sort.popular')}</option>
              <option value="rating">{t('common:pluginMarketplace.sort.rating')}</option>
              <option value="newest">{t('common:pluginMarketplace.sort.newest')}</option>
              <option value="name">{t('common:pluginMarketplace.sort.name')}</option>
            </select>
            <Button
        ...
        {isCatalogLoading ? (
          ...
          <>
            <p className="text-xs text-muted-foreground mb-4">
              {t('common:pluginMarketplace.resultsCount', { count: filteredPlugins.length })}
            </p>
