...
const PLUGIN_TYPES = [
  { type: 'agent', color: '#8b5cf6', descKey: 'common:pluginMarketplace.sdk.typeDesc.agent' },
  { type: 'integration', color: '#3b82f6', descKey: 'common:pluginMarketplace.sdk.typeDesc.integration' },
  { type: 'spec-template', color: '#10b981', descKey: 'common:pluginMarketplace.sdk.typeDesc.specTemplate' },
  { type: 'theme', color: '#f97316', descKey: 'common:pluginMarketplace.sdk.typeDesc.theme' },
  { type: 'custom-prompt', color: '#ec4899', descKey: 'common:pluginMarketplace.sdk.typeDesc.customPrompt' },
];
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="shrink-0 border-b border-border bg-gradient-to-b from-primary/5 to-transparent px-6 py-8">
        <div className="max-w-2xl">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h2 className="text-xl font-bold">{t('common:pluginMarketplace.sdk.title')}</h2>
          </div>
      ...
      <div className="px-6 py-6 space-y-6">
        {SDK_SECTIONS.map(({ icon: Icon, titleKey, color, descKey, codeSnippet }) => (
          <div
            key={titleKey}
