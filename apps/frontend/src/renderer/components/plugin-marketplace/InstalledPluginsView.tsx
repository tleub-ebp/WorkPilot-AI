  ...
  if (installed.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3 text-muted-foreground">
        ...
        <p className="text-sm font-medium">{t('common:pluginMarketplace.noInstalledPlugins')}</p>
        <p className="text-xs">{t('common:pluginMarketplace.browseToInstall')}</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto px-6 py-4">
      <p className="text-xs text-muted-foreground mb-4">
        {t('common:pluginMarketplace.installedCount', { count: installed.length })}
      </p>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => togglePlugin(plugin.pluginId, checked)}
                  aria-label={
                    plugin.enabled
