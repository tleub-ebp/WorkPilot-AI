    ...
    <>
      ...
      {project.autoBuildPath && (
        <>
          ...
          {/* Agent Settings */}
          <section className="space-y-4">
            <h3 className="text-sm font-semibold text-foreground">{t('projectSections.agentConfiguration.title')}</h3>
            <div className="space-y-2">
              <Label htmlFor="model" className="text-sm font-medium text-foreground">{t('projectSections.agentConfiguration.model')}</Label>
              <Select
