						...
						<div className="rounded-lg bg-success/10 border border-success/30 p-4 flex items-center gap-3">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-success/80 mt-1">
									You can now use AI features like Ideation and Roadmap
									generation.
								</p>
							</div>
						</div>
									...
									<div className="flex items-start gap-3">
										...
										<div className="flex-1">
											...
											<p className="text-xs text-muted-foreground">
												You have {claudeProfiles.length} authenticated Claude
												account{claudeProfiles.length > 1 ? "s" : ""}. Select
												one to use:
											</p>
										</div>
									</div>
							...
							<div className="space-y-3">
								...
								{isAuthenticating && (
									<p className="text-xs text-muted-foreground text-center">
										A browser window should open. Complete the authentication
						...
						{hasExistingToken && (
							<div className="rounded-lg bg-muted/50 p-3">
								<p className="text-sm text-muted-foreground">
									...
									{showManualEntry
										? "Enter a new token above to replace it."
										: "Authenticate again to replace it."}
								</p>
							</div>
						)}
					</div>
