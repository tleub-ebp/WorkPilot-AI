	...
	const tips = [
		{
			...
			description:
				"Clearly describe what you want to build. Include requirements, constraints, and expected behavior.",
		},
		{
			icon: <Target className="h-4 w-4" />,
			title: "Start Small",
			description:
				"Begin with a focused task like adding a feature or fixing a bug. Smaller tasks are easier to verify.",
		},
		{
			icon: <ListChecks className="h-4 w-4" />,
			title: "Include Context",
			description:
				"Mention relevant files, APIs, or patterns. The more context you provide, the better the results.",
		},
		{
			icon: <Sparkles className="h-4 w-4" />,
			title: "Let AI Help",
			description:
				"The AI can generate titles and classify tasks. Focus on describing what you want, not the details.",
		},
	];
			...
			<div className="w-full max-w-2xl">
				...
				<div className="text-center mb-8">
					...
					<p className="mt-2 text-muted-foreground">
						Describe what you want to build and let WorkPilot AI handle the rest
					</p>
				</div>
							...
							<div className="flex items-start gap-4">
								...
								<div className="flex-1">
									...
									<p className="mt-1 text-sm text-success/80">
										Great! You can create your first task now or continue with
										the wizard. You can always create tasks later from the main
										dashboard.
									</p>
								</div>
							</div>
						...
						<div className="flex items-start gap-4">
							...
							<div className="flex-1 space-y-2">
								...
								<p className="text-sm text-muted-foreground italic">
									...
									persist the user&apos;s preference in localStorage and apply
									the theme immediately without page reload. Use the existing
									color variables in styles/theme.css.&quot;
								</p>
							</div>
						</div>
					</CardContent>
