			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div className="space-y-2">
					...
					>
						<SelectTrigger id={`${prefix}category`} className="h-9">
							<SelectValue
								placeholder={t("form.classification.selectCategory")}
							/>
						</SelectTrigger>
						<SelectContent>
				...
				<div className="space-y-2">
					...
					>
						<SelectTrigger id={`${prefix}priority`} className="h-9">
							<SelectValue
								placeholder={t("form.classification.selectPriority")}
							/>
						</SelectTrigger>
						<SelectContent>
				...
				<div className="space-y-2">
					...
					<Select
						value={complexity}
						onValueChange={(value) =>
							onComplexityChange(value as TaskComplexity)
						}
						disabled={disabled}
					>
						<SelectTrigger id={`${prefix}complexity`} className="h-9">
							<SelectValue
								placeholder={t("form.classification.selectComplexity")}
							/>
						</SelectTrigger>
						<SelectContent>
				...
				<div className="space-y-2">
					...
					>
						<SelectTrigger id={`${prefix}impact`} className="h-9">
							<SelectValue
								placeholder={t("form.classification.selectImpact")}
							/>
						</SelectTrigger>
						<SelectContent>
