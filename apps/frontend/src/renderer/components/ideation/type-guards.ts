...
export function isDocumentationGapIdea(
	idea: Idea,
): idea is DocumentationGapIdea {
	return idea.type === "documentation_gaps";
}

export function isSecurityHardeningIdea(
	idea: Idea,
): idea is SecurityHardeningIdea {
	return idea.type === "security_hardening";
}

export function isPerformanceOptimizationIdea(
	idea: Idea,
): idea is PerformanceOptimizationIdea {
