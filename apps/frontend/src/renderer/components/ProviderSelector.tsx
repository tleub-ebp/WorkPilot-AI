...
const providerIcons: Record<string, React.ReactNode> = {
  ...
  ollama: (
    <svg width="20" height="20" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ollama">
      ...
      <circle cx="36" cy="32" r="10" fill="#222"/>
      <circle cx="64" cy="32" r="10" fill="#222"/>
      <ellipse cx="50" cy="62" rx="22" ry="18" fill="#222"/>
      <rect x="29" y="74" width="10" height="18" rx="5" fill="#222"/>
      <rect x="61" y="74" width="10" height="18" rx="5" fill="#222"/>
