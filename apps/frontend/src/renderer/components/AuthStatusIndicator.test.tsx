 ...
 */
function createUseSettingsStoreMock(
...
describe("AuthStatusIndicator", () => {
	...
	describe("when using OAuth (no active profile)", () => {
		...
		it("should display Anthropic badge with Lock icon for OAuth", () => {
			...
			expect(
				screen.getByRole("button", { name: /authentication: anthropic/i }),
			).toBeInTheDocument();
		});
	...
	describe("component structure", () => {
		beforeEach(() => {
			vi.mocked(useSettingsStore).mockReturnValue(createUseSettingsStoreMock());
		});
