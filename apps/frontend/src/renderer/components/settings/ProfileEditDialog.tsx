...
import { isValidApiKey, isValidUrl, maskApiKey } from "../../lib/profile-utils";
...
export function ProfileEditDialog({
	...
	const handleTestConnection = async () => {
		...
		const apiKeyForTest =
			isEditMode && !isChangingApiKey && profile ? profile.apiKey : apiKey;
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			...
			>
					...
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div className={`space-y-2 ${isEditMode ? "md:col-span-2" : ""}`}>
							<Label htmlFor="profile-name">
								{t("settings:apiProfiles.fields.name")}{" "}
						...
						{!isEditMode && (
							<div className="space-y-2">
								<Label htmlFor="profile-preset">
									{t("settings:apiProfiles.fields.preset")}
								</Label>
								<Select value={presetId} onValueChange={applyPreset}>
									<SelectTrigger id="profile-preset">
										<SelectValue
											placeholder={t(
												"settings:apiProfiles.placeholders.preset",
											)}
										/>
									</SelectTrigger>
									<SelectContent
					...
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div className="space-y-2">
							<Label htmlFor="profile-url">
								{t("settings:apiProfiles.fields.baseUrl")}{" "}
								<span className="text-destructive">*</span>
							</Label>
							<Input
								id="profile-url"
						...
						<div className="space-y-2">
							<Label htmlFor="profile-key">
								{t("settings:apiProfiles.fields.apiKey")}{" "}
								<span className="text-destructive">*</span>
							</Label>
						...
						<div className="grid gap-4 md:grid-cols-2">
							<div className="space-y-2">
								...
								<ModelSearchableSelect
									...
									placeholder={t(
										"settings:apiProfiles.models.defaultPlaceholder",
									)}
									baseUrl={baseUrl}
									apiKey={
										isEditMode && !isChangingApiKey && profile
							...
							<div className="space-y-2">
								...
								<ModelSearchableSelect
									...
									placeholder={t(
										"settings:apiProfiles.models.haikuPlaceholder",
									)}
									baseUrl={baseUrl}
									apiKey={
										isEditMode && !isChangingApiKey && profile
							...
							<div className="space-y-2">
								...
								<ModelSearchableSelect
									...
									placeholder={t(
										"settings:apiProfiles.models.sonnetPlaceholder",
									)}
									baseUrl={baseUrl}
									apiKey={
										isEditMode && !isChangingApiKey && profile
				...
				<DialogFooter>
					...
					<Button type="button" onClick={handleSave} disabled={profilesLoading}>
						{profilesLoading ? (
							<>
								<Loader2 className="mr-2 h-4 w-4 animate-spin" />
