...
export function createHookProxy(
  ...
  return {
    ...
    get showAzureDevOpsImportModal() { return hookRef.current.showAzureDevOpsImportModal; },
    get setShowAzureDevOpsImportModal() { return hookRef.current.setShowAzureDevOpsImportModal; },
