					...
					<div className="flex items-center gap-3">
						...
						<div>
							<h2 className="text-2xl font-bold text-gray-900 tracking-tight">
								{t("accounts.multiConnector.title")}
							</h2>
							<p className="text-sm text-gray-600 mt-0.5">
								{t("accounts.multiConnector.description")}
							</p>
						</div>
					</div>
					...
					<div className="flex flex-wrap gap-3">
						<div className="px-3 py-1.5 bg-gray-100/50 rounded-lg">
							<span className="text-sm font-medium text-gray-700">
								{t("accounts.multiConnector.stats.total", {
									count: stats.total,
								})}
							</span>
						</div>
						<div className="px-3 py-1.5 bg-emerald-50/50 rounded-lg border border-emerald-200/50">
							<span className="text-sm font-medium text-emerald-700">
								{t("accounts.multiConnector.stats.configured", {
						...
						{stats.errors > 0 && (
							<div className="px-3 py-1.5 bg-red-50/50 rounded-lg border border-red-200/50">
								<span className="text-sm font-medium text-red-700">
									{t("accounts.multiConnector.stats.errors", {
										count: stats.errors,
									})}
								</span>
							</div>
					...
					<div className="flex gap-3">
						...
						>
							...
							<SelectContent className="rounded-xl border-gray-200/50">
								...
								<SelectItem value="configured" className="rounded-lg">
									Configurés
								</SelectItem>
								<SelectItem value="unconfigured" className="rounded-lg">
									Non configurés
								</SelectItem>
								<SelectItem value="errors" className="rounded-lg">
									Avec erreurs
								</SelectItem>
							</SelectContent>
						</Select>
						...
						>
							...
							<SelectContent className="rounded-xl border-gray-200/50">
								...
								<SelectItem value="usage" className="rounded-lg">
									Utilisation
								</SelectItem>
							</SelectContent>
						</Select>
