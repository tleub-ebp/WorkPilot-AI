          ...
          <div className="pl-4 space-y-5 border-l-2 border-primary/20">
            ...
            <div className="space-y-2.5">
              ...
              <input
                ...
                onChange={(e) => setConfig({ maxParallelAgents: Number.parseInt(e.target.value, 10) })}
            ...
            <div className="space-y-2.5">
              ...
              <input
                ...
                onChange={(e) => setConfig({ maxRetriesPerSubtask: Number.parseInt(e.target.value, 10) })}
                className="w-full accent-primary"
              />
              <div className="flex justify-between text-[10px] text-muted-foreground px-0.5">
                <span>0</span>
