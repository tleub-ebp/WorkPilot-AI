...
import { Check, Globe, Pencil, Plus, Server, Trash2 } from "lucide-react";
	...
	const handleDeleteProfile = async () => {
		...
		if (success) {
			...
			toast({
				...
				description:
					profilesError || t("settings:apiProfiles.toast.delete.errorFallback"),
			});
		}
	};
	...
	const handleSetActiveProfile = async (profileId: string | null) => {
		...
		if (success) {
			...
			if (profileId === null) {
				...
				if (activeProfile) {
					toast({
						...
						description: t(
							"settings:apiProfiles.toast.switch.profileDescription",
							{
			...
			toast({
				...
				description:
					profilesError || t("settings:apiProfiles.toast.switch.errorFallback"),
			});
		}
	};
		...
		<div className="space-y-4">
							...
							>
								<div className="flex-1 min-w-0">
									...
									<div className="flex items-center gap-4 text-sm text-muted-foreground">
										...
										<div className="truncate">{maskApiKey(profile.apiKey)}</div>
									</div>
								...
								<div className="flex items-center gap-2">
									...
									<Tooltip>
										...
										<TooltipContent>
											{t("settings:apiProfiles.tooltips.edit")}
										</TooltipContent>
									</Tooltip>
									<Tooltip>
										<TooltipTrigger asChild>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>
							{t("settings:apiProfiles.dialog.deleteTitle")}
						</AlertDialogTitle>
						<AlertDialogDescription>
