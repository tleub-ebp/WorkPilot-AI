import { FolderPlus, FolderOpen, Sparkles, GitBranch, Zap } from 'lucide-react';
      ...
      <div className="w-full max-w-lg flex flex-col items-center gap-8">
        ...
        <div className="flex items-start gap-4 w-full">
          <div className="shrink-0 w-9 h-9 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center">
            <span className="text-primary text-base font-bold select-none">W</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full justify-center">
          ...
          <Button size="lg" variant="outline" onClick={onAddProject} className="gap-2">
