...
const TABS: Array<{ id: IncidentMode; icon: string; labelKey: string }> = [
  ...
  { id: 'production', icon: '\uD83C\uDFED', labelKey: 'selfHealing:tabProduction' },
  { id: 'proactive', icon: '\uD83D\uDD2E', labelKey: 'selfHealing:tabProactive' },
];
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        {isLoading ? (
          ...
          <>
            ...
            {activeTab === 'production' && <ProductionTab projectPath={projectPath} />}
            {activeTab === 'proactive' && <ProactiveTab projectPath={projectPath} />}
          </>
        )}
      </div>
    </div>
