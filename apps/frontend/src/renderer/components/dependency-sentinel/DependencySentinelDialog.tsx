  ...
  const mockVulnerabilities: Vulnerability[] = [
    {
      ...
      package: 'axios',
      version: '1.4.0',
      description: 'Axios versions before 1.6.0 are vulnerable to prototype pollution.',
    ...
    <Dialog open={isOpen} onOpenChange={closeDialog}>
      <DialogContent className="max-w-4xl max-h-[80vh]">
        <DialogHeader>
          ...
          <DialogDescription>
            {t('dialogs:dependencySentinel.description', 'Monitor dependencies for security vulnerabilities and outdated packages')}
          </DialogDescription>
        </DialogHeader>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1">
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="vulnerabilities" className="flex items-center gap-2">
                ...
                {t('dialogs:dependencySentinel.vulnerabilities', 'Vulnerabilities')}
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {dep.severity && (
                                <Badge className={SEVERITY_COLORS[dep.severity]}>
                                  {dep.severity}
                                </Badge>
                              )}
                            </div>
                        ...
                        <CardContent>
                          ...
                          {dep.recommendation && (
                            <div className="flex items-start gap-2 text-sm">
                              ...
                              <span className="text-green-700">{dep.recommendation}</span>
                            </div>
                          )}
                        </CardContent>
                      </Card>
                      ...
                      <Card key={vuln.id}>
                        ...
                        <CardContent>
                          ...
                          <div className="flex items-start gap-2 text-sm">
                            ...
                            <span className="text-orange-700">{vuln.recommendation}</span>
                          </div>
                        </CardContent>
                      </Card>
                    ))
