...
export async function switchSession(
	...
	const result = await window.electronAPI.switchInsightsSession(
		projectId,
		sessionId,
	);
	if (result.success && result.data) {
...
export async function deleteSession(
	...
	const result = await window.electronAPI.deleteInsightsSession(
		projectId,
		sessionId,
	);
	if (result.success) {
...
export async function renameSession(
	...
	const result = await window.electronAPI.renameInsightsSession(
		projectId,
		sessionId,
		newTitle,
	);
...
export async function updateModelConfig(
	...
	const result = await window.electronAPI.updateInsightsModelConfig(
		projectId,
		sessionId,
		modelConfig,
	);
