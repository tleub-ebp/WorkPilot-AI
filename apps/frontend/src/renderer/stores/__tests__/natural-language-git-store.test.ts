...
describe("NaturalLanguageGitStore", () => {
	...
	describe("IPC Event Handling", () => {
		...
		beforeEach(() => {
			mockElectronAPI.onNaturalLanguageGitStatus.mockReturnValue(() => {
				/* noop */
			});
			mockElectronAPI.onNaturalLanguageGitStreamChunk.mockReturnValue(() => {
				/* noop */
			});
			mockElectronAPI.onNaturalLanguageGitError.mockReturnValue(() => {
				/* noop */
			});
			mockElectronAPI.onNaturalLanguageGitComplete.mockReturnValue(() => {
				/* noop */
			});
			cleanup = null;
		});
		...
		it("should handle status events", () => {
			...
			const statusCallback =
				mockElectronAPI.onNaturalLanguageGitStatus.mock.calls[0][0];
			act(() => {
		...
		it("should handle stream chunk events", () => {
			...
			const streamCallback =
				mockElectronAPI.onNaturalLanguageGitStreamChunk.mock.calls[0][0];
			act(() => {
		...
		it("should handle error events", () => {
			...
			const errorCallback =
				mockElectronAPI.onNaturalLanguageGitError.mock.calls[0][0];
			act(() => {
		...
		it("should handle complete events", () => {
			...
			const completeCallback =
				mockElectronAPI.onNaturalLanguageGitComplete.mock.calls[0][0];
			const mockResult = {
	...
	describe("Command Execution", () => {
		...
		it("should handle execution error", async () => {
			...
			mockElectronAPI.executeNaturalLanguageGit.mockRejectedValue(
				new Error("API Error"),
			);
	...
	describe("Cleanup", () => {
		it("should remove event listeners on cleanup", () => {
			...
			expect(
				mockElectronAPI.onNaturalLanguageGitStreamChunk,
			).toHaveBeenCalled();
