...
export function startPlayground(
	...
	if (
		...
		typeof globalThis.electronAPI.startCodePlayground === "function"
	) {
		globalThis.electronAPI.startCodePlayground(
			projectId,
			idea,
			playgroundType,
			sandboxType,
...
export function setupCodePlaygroundListeners() {
	...
	const unsubChunk =
		globalThis.electronAPI &&
		typeof globalThis.electronAPI.onCodePlaygroundStreamChunk === "function"
	...
	const unsubStatus =
		globalThis.electronAPI &&
		typeof globalThis.electronAPI.onCodePlaygroundStatus === "function"
	...
	const unsubError =
		globalThis.electronAPI &&
		typeof globalThis.electronAPI.onCodePlaygroundError === "function"
	...
	const unsubComplete =
		globalThis.electronAPI &&
		typeof globalThis.electronAPI.onCodePlaygroundComplete === "function"
