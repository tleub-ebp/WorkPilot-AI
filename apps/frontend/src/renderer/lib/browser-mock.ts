...
const browserMockAPI: ElectronAPI = {
  ...
  github: {
    ...
    startAutoFix: () => { /* noop */ },
    onAutoFixProgress: () => () => { /* noop */ },
    onAutoFixComplete: () => () => { /* noop */ },
    onAutoFixError: () => () => { /* noop */ },
  ...
  onLearningLoopStatus: () => () => { /* noop */ },
  onLearningLoopStreamChunk: () => () => { /* noop */ },
  onLearningLoopError: () => () => { /* noop */ },
  onLearningLoopComplete: () => () => { /* noop */ },
  ...
  // Conflict Predictor
  runConflictPrediction: async () => { /* noop */ },
  cancelConflictPrediction: async () => false,
  onConflictPredictionStreamChunk: () => () => { /* noop */ },
  onConflictPredictionStatus: () => () => { /* noop */ },
  onConflictPredictionError: () => () => { /* noop */ },
  onConflictPredictionComplete: () => () => { /* noop */ },
  onConflictPredictionEvent: () => () => { /* noop */ },
