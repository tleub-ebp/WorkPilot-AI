...
export const mockTasks = [
	...
	},
	{
		...
		description:
			"Create a real-time analytics dashboard with charts and metrics",
		...
		subtasks: [
			...
			},
			{
				...
				description: "Implement API calls for metrics",
		...
		logs: [
			"[INFO] Starting task...",
			"[INFO] Subtask 1 completed",
			"[INFO] Working on subtask 2...",
		],
	...
	},
	{
		...
		subtasks: [
			{
				id: "subtask-1",
				title: "Fix pagination logic",
				description: "Correct the offset calculation",
				status: "completed" as const,
		...
		subtasks: [
			{
				...
				description: "Build centralized API client",
				status: "completed" as const,
			...
			},
			{
				...
				description: "Update all components to use new service",
				status: "completed" as const,
