...
describe("stripAnsiCodes", () => {
	...
	describe("real-world Python debug output examples", () => {
		it("should handle typical Python debug module output", () => {
			const input =
				"\x1b[90m[21:40:22.196]\x1b[0m \x1b[36m[DEBUG]\x1b[0m \x1b[96mSending query to agent\x1b[0m";
		...
		it("should handle INFO level logs", () => {
			const input =
				"\x1b[90m[21:40:25.123]\x1b[0m \x1b[32m[INFO]\x1b[0m \x1b[96mProcessing request\x1b[0m";
		...
		it("should handle WARNING level logs", () => {
			const input =
				"\x1b[90m[21:40:28.456]\x1b[0m \x1b[33m[WARNING]\x1b[0m \x1b[96mRate limit approaching\x1b[0m";
		...
		it("should handle ERROR level logs", () => {
			const input =
				"\x1b[90m[21:40:30.789]\x1b[0m \x1b[31m[ERROR]\x1b[0m \x1b[96mConnection failed\x1b[0m";
		...
		it("should handle multi-line debug output", () => {
			const input =
				"\x1b[90m[21:40:22.196]\x1b[0m \x1b[36m[DEBUG]\x1b[0m Starting process\n\x1b[90m[21:40:23.200]\x1b[0m \x1b[36m[DEBUG]\x1b[0m Process complete";
			const expected =
				"[21:40:22.196] [DEBUG] Starting process\n[21:40:23.200] [DEBUG] Process complete";
			expect(stripAnsiCodes(input)).toBe(expected);
		});
	});
	...
	describe("common ANSI escape patterns", () => {
		...
		it("should handle foreground color codes (30-37, 90-97)", () => {
			...
			expect(stripAnsiCodes("\x1b[90mbright black\x1b[0m")).toBe(
				"bright black",
			);
			expect(stripAnsiCodes("\x1b[91mbright red\x1b[0m")).toBe("bright red");
			expect(stripAnsiCodes("\x1b[97mbright white\x1b[0m")).toBe(
				"bright white",
			);
		});

		it("should handle background color codes (40-47, 100-107)", () => {
			expect(stripAnsiCodes("\x1b[40m\x1b[37mon black bg\x1b[0m")).toBe(
				"on black bg",
			);
			expect(stripAnsiCodes("\x1b[41m\x1b[37mon red bg\x1b[0m")).toBe(
				"on red bg",
			);
		});
	});
	...
	describe("integration test cases", () => {
		it("should handle actual roadmap progress message format", () => {
			const input =
				"\x1b[90m[21:40:22.196]\x1b[0m \x1b[36m[DEBUG]\x1b[0m \x1b[96mAnalyzing project structure\x1b[0m";
		...
		it("should handle ideation progress message format", () => {
			const input =
				"\x1b[90m[10:15:30.500]\x1b[0m \x1b[32m[INFO]\x1b[0m \x1b[96mGenerating research questions\x1b[0m";
