...
export function isValidPhaseTransition(
	...
	if (!hasCompletedPrerequisite) {
		console.warn(
			`[isValidPhaseTransition] Blocked transition ${currentPhase} -> ${newPhase}: prerequisite phases not completed`,
			{
 ...
 */
export function getExpectedPreviousPhase(
