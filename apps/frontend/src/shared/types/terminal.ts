...
export interface TerminalWorktreeConfig {
  ...
  name: string;
  /** Path to the worktree directory (.workpilot/worktrees/terminal/{name}/) */
  worktreePath: string;
...
/**
 * Information about a worktree not managed by WorkPilot AI
 * Discovered via `git worktree list` excluding WorkPilot AI paths
 */
