...
function parseReviewResult(data: RawReviewData): MRReviewResult {
	return {
		...
		overallStatus:
			(data.overall_status as MRReviewResult["overallStatus"]) ?? "comment",
...
describe("GitLab MR Review Handlers", () => {
	...
	describe("formatReviewBody", () => {
		...
		it("should format review header", () => {
			...
			expect(body).toContain("## WorkPilot AI MR Review");
		...
		it("should include footer", () => {
			...
			expect(body).toContain("*This review was generated by WorkPilot AI.*");
		});
