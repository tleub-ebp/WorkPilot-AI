...
This directory contains the refactored IPC (Inter-Process Communication) handlers for WorkPilot AI UI, organized into domain-specific modules for better maintainability and code organization.
