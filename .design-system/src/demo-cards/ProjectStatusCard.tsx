...
import { AvatarGroup, Card, ProgressCircle } from "../components";
	...
	return (
		<Card className="w-[380px]">
			...
			<p className="text-body-medium text-(--color-text-secondary) mb-4">
				In today's fast-paced digital landscape, our mission is to transform our
				website into a more intuitive, engaging, and user-friendly platfor...
			</p>
