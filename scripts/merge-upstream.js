...
if (isWindows) {
    ...
    try {
        execSync('powershell -NoProfile -Command "Get-ExecutionPolicy -Scope CurrentUser" 2>&1', {
            stdio: 'pipe',
            encoding: 'utf-8'
        });
...
if (!fs.existsSync(scriptPath)) {
    ...
    console.error(`Please ensure merge-upstream scripts are in the repository root.`);
    process.exit(1);
}
